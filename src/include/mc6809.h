...
#define reverse_bytes(x) __builtin_bswap16(x)
...
struct processor {
	union ba_bs_u old_bus_state;
	union ba_bs_u bus_state;
...
#define SYSTEM_REQUEST		0x01u
#define SYSTEM_REQUEST_RESPONSE	0x02u
#define SYSTEM_TIMER_CONTROL	0x03u
